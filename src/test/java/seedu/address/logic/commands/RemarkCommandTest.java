...
public class RemarkCommandTest {
    ...
    public void equals() {
        ...
        assertNotEquals(new RemarkCommand(INDEX_SECOND_PERSON,
                new Remark(VALID_REMARK_AMY)), standardCommand);
        // different remark -> returns false
        assertNotEquals(new RemarkCommand(INDEX_FIRST_PERSON,
                new Remark(VALID_REMARK_BOB)), standardCommand);
    }
}
